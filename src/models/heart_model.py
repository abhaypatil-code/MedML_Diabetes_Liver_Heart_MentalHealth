...
def train_heart_model(data_path="data/raw/heart.csv"):
    print("="*70)
    ...
    X_train, X_test, y_train, y_test = preprocess_heart_data(data_path)
    
    # 2. Model Training
    print("2. Initializing Advanced Trainer...")
    trainer = AdvancedTrainer("heart", X_train, X_test, y_train, y_test)
